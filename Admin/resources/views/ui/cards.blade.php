...
@section('content')
    ...
    <div class="grid 2xl:grid-cols-4 grid-cols-1 gap-6">
        <div class="card">
            <img alt="Image Description" class="w-full h-auto rounded-t-xl"
        ...
        <div class="card">
            ...
            <img alt="Image Description" class="w-full h-auto rounded-b-xl"
                 src="{{ asset('images/small/img-4.jpg') }}"/>
        </div>
        <div class="card">
            <img alt="Image Description" class="w-full h-auto rounded-xl" src="{{ asset('images/small/img-2.jpg') }}"/>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white border border-default-200 rounded-xl shadow-sm sm:flex">
                <div
                    ...
                    <img alt="Image Description" class="size-full absolute top-0 start-0 object-cover"
                         src="{{ asset('images/small/img-4.jpg') }}"/>
                </div>
    ...
    <div>
        <div
            class="grid border border-default-200 rounded-xl shadow-sm divide-y divide-default-200 overflow-hidden sm:flex sm:divide-y-0 sm:divide-x">
            <div class="flex flex-col flex-[1_0_0%] bg-white">
                <img alt="Image Description" class="w-full h-auto rounded-t-xl sm:rounded-se-none"
                ...
                <div class="p-4 border-t border-default-200 sm:px-5">
                    <p class="text-xs text-default-500">
                        Last updated 5 mins ago
                    </p>
                </div>
            ...
            <div class="flex flex-col flex-[1_0_0%] bg-white">
                <img alt="Image Description" class="w-full h-auto"
                     src="https://images.unsplash.com/photo-1680868543815-b8666dba60f7?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=2532&amp;q=80"/>
                <div class="p-4 flex-1 md:p-5">
                    <h3 class="text-lg font-bold text-default-800">
                        Card title
            ...
            <div class="flex flex-col flex-[1_0_0%] bg-white">
                <img alt="Image Description" class="w-full h-auto sm:rounded-se-xl"
                     src="https://images.unsplash.com/photo-1680868543815-b8666dba60f7?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=2532&amp;q=80"/>
                <div class="p-4 flex-1 md:p-5">
                    <h3 class="text-lg font-bold text-default-800">
                        Card title
