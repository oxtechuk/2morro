            ...
            <div class="p-6">
                ...
                <div
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button class="ms-auto h-8 w-8 rounded-full bg-default-200 flex justify-center items-center"
                                data-hs-remove-element="#dismiss-alert" id="dismiss-test" type="button">
