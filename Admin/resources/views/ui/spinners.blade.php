...
@section('content')
    @include('shared.partials.page-title', ['subtitle' => 'Components', 'title' => 'Spinner'])
            ...
            <div class="card-body">
                <div class="flex flex-wrap items-center gap-2">
                    <div aria-label="loading"
                         class="animate-spin w-8 h-8 border-[3px] border-current border-t-transparent text-default-600 rounded-full"
                         role="status">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="flex flex-wrap gap-2">
                    <div aria-label="loading"
                         class="animate-spin w-8 h-8 border-[3px] border-current border-t-transparent text-primary rounded-full"
                         role="status">
                        <span class="sr-only">Loading...</span>
                    </div>
                    <div aria-label="loading"
                         class="animate-spin w-8 h-8 border-[3px] border-current border-t-transparent text-default-500 rounded-full"
                         role="status">
                        <span class="sr-only">Loading...</span>
                    </div>
                    <div aria-label="loading"
                         class="animate-spin w-8 h-8 border-[3px] border-current border-t-transparent text-teal-500 rounded-full"
                         role="status">
                        <span class="sr-only">Loading...</span>
                    </div>
                    <div aria-label="loading"
                         class="animate-spin w-8 h-8 border-[3px] border-current border-t-transparent text-red-500 rounded-full"
                         role="status">
                        <span class="sr-only">Loading...</span>
                    </div>
                    <div aria-label="loading"
                         class="animate-spin w-8 h-8 border-[3px] border-current border-t-transparent text-amber-500 rounded-full"
                         role="status">
                        <span class="sr-only">Loading...</span>
                    </div>
                    <div aria-label="loading"
                         class="animate-spin w-8 h-8 border-[3px] border-current border-t-transparent text-cyan-500 rounded-full"
                         role="status">
                        <span class="sr-only">Loading...</span>
                    </div>
                    <div aria-label="loading"
                         class="animate-spin w-8 h-8 border-[3px] border-current border-t-transparent text-default-200 rounded-full"
                         role="status">
                        <span class="sr-only">Loading...</span>
                    </div>
                    <div aria-label="loading"
                         class="animate-spin w-8 h-8 border-[3px] border-current border-t-transparent text-default-900 rounded-full"
                         role="status">
                        <span class="sr-only">Loading...</span>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="">
                    ...
                    <p class="text-default-600 text-sm font-medium">Use <code class="text-primary">.flex</code> class or
                        <code class="text-primary">text-{alignment}</code> utilities to place spinners
                        exactly
                ...
                <div class="grid sm:grid-cols-2 gap-6">
                    <div class="flex items-center gap-4">
                        <button
                            ...
                            type="button">
                            <div aria-label="loading"
                                 class="animate-spin w-5 h-5 border-[3px] border-current border-t-transparent rounded-full"
                                 role="status">
                                <span class="sr-only">Loading...</span>
                            </div>
                        </button> <!-- button-end -->
