@extends('shared.vertical', ['title' => 'Popover'])
...
@section('content')
    @include('shared.partials.page-title', ['subtitle' => 'Apps', 'title' => 'Popover'])
                ...
                <div class="flex flex-wrap gap-3">
                    <div class="hs-tooltip inline-block [--trigger:click] [--placement:top]">
                        <a class="hs-tooltip-toggle block text-center" href="javascript:;">
                            ...
                            <div
                                class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible transition-opacity opacity-0 relative hidden px-3 py-1 rounded bg-default-800 text-default-200 font-medium w-60 z-50"
                                role="tooltip">
                ...
                <div class="flex flex-wrap gap-3">
                    <div class="hs-tooltip inline-block [--trigger:focus] [--placement:bottom-left]">
                        <a class="hs-tooltip-toggle block text-center" href="javascript:;">
                            ...
                            <div
                                class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible hidden opacity-0 transition-opacity absolute invisible z-70 max-w-xs bg-white border border-default-200 text-start rounded-lg shadow-md"
                                role="tooltip">
                                <span class="pt-3 px-4 block text-lg font-bold text-default-800">Overview</span>
                                <div class="py-3 px-4 text-sm text-default-600">
                                    <svg class="rounded-lg mb-3" fill="none" viewbox="0 0 500 300"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <rect class="text-default-300 fill-current" height="300" width="500"></rect>
                                        <path
            ...
            <div class="card-body">
                ...
                <div class="hs-tooltip [--trigger:hover] sm:[--placement:right] inline-block">
                    <div
                        ...
                        <img alt="Image Description" class="inline-block size-9 rounded-full"
                        ...
                        <!-- Popover Content -->
                        <div
                            class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible hidden opacity-0 transition-opacity absolute invisible z-10 max-w-xs w-full bg-white border border-default-100 text-start rounded-xl shadow-md after:absolute after:top-0 after:-start-4 after:w-4 after:h-full"
                            role="tooltip">
                            <!-- Header -->
                            <div class="py-3 px-4 border-b border-default-200">
                                <div class="flex items-center gap-x-3">
                                    <img alt="Image Description"
                                         class="flex-shrink-0 inline-block size-10 rounded-full ring-2 ring-white"
                                         src="{{ asset('images/users/avatar-1.jpg') }}"/>
                                    <div class="grow">
                            ...
                            <ul class="py-3 px-4 space-y-1">
                                <li>
                                    <div class="inline-flex items-center gap-x-3 text-sm text-default-800">
                                        <i class="iconify tabler--building text-base text-default-600"></i>
                                        Pixeel Ltd.
                                    </div>
                                </li>
                                <li>
                                    <div class="inline-flex items-center gap-x-3 text-sm text-default-800">
                                        <i class="iconify tabler--device-mobile text-base text-default-600"></i>
                                        (892) 312-5483
                                    </div>
                                </li>
                                <li>
                                    <div class="inline-flex items-center gap-x-3 text-sm text-default-800">
                                        <i class="iconify tabler--mail text-base text-default-600"></i>
                                        amanda@email.com
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="py-2 px-4 flex justify-between items-center bg-default-100">
                                <a class="inline-flex items-center gap-x-1.5 text-xs text-default-500 hover:text-primary disabled:opacity-50 disabled:pointer-events-none"
                                   href="#">
                                    <i class="iconify tabler--flag text-base"></i>
                                    Flag
                                </a>
                                <button class="btn bg-primary text-white" type="button">Follow</button>
                            </div>
                            <!-- End Footer -->
                        </div>
                        <!-- End Popover Content -->
