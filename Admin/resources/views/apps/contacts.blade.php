@extends('shared.vertical', ['title' => 'Contacts'])
...
@section('content')
    @include('shared.partials.page-title', ['subtitle' => 'Menu', 'title' => 'Contacts'])
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-7.5">
        ...
        <div class="card overflow-hidden">
            <!-- Cover Image Section -->
            <div class="relative">
                <img alt="Cover Image" class="w-full h-44 object-cover" src="{{ asset('images/small/img-1.jpg') }}"/>
                <!-- Profile Image with Status -->
                <div class="absolute -bottom-14 start-1/2 transform -translate-x-1/2">
                    <div class="relative">
                        <img alt="Profile Picture" class="w-28 h-28 rounded-full border-4 border-white shadow-md"
            ...
            <div class="py-4 px-6">
                <div class="flex justify-center space-x-6">
                    <a class="text-primary hover:text-blue-700 transition-all" href="#">
                        <i class="iconify ph--facebook-logo text-3xl"></i>
                    </a>
                    <a class="text-pink-500 hover:text-pink-700 transition-all" href="#">
                        <i class="iconify ph--instagram-logo text-3xl"></i>
                    </a>
                    <a class="text-blue-700 hover:text-blue-900 transition-all" href="#">
                        <i class="iconify ph--linkedin-logo text-3xl"></i>
                    </a>
                    <a class="text-default-700 hover:text-default-900 transition-all" href="#">
                        <i class="iconify ph--x-logo text-3xl"></i>
                    </a>
                </div>
            </div>
            <!-- Action Buttons -->
        ...
        <div class="card overflow-hidden">
            <div class="relative">
                <img alt="Cover Image" class="w-full h-44 object-cover" src="{{ asset('images/small/img-2.jpg') }}"/>
                <div class="absolute -bottom-14 start-1/2 transform -translate-x-1/2">
                    <div class="relative">
                        <img alt="Profile Picture" class="w-28 h-28 rounded-full border-4 border-white shadow-md"
                             src="{{ asset('images/users/avatar-2.jpg') }}"/>
                        <span
                            class="absolute bottom-1 end-1 w-5 h-5 bg-red-500 border-2 border-white rounded-full"></span>
                    </div>
                </div>
            </div>
            <div class="pt-16 pb-4 text-center">
            ...
            <div class="py-4 px-6">
                <div class="flex justify-center space-x-6">
                    <a class="text-primary hover:text-blue-700 transition-all" href="#"><i
                            class="iconify ph--facebook-logo text-3xl"></i></a>
                    <a class="text-pink-500 hover:text-pink-700 transition-all" href="#"><i
                            class="iconify ph--instagram-logo text-3xl"></i></a>
                    <a class="text-blue-700 hover:text-blue-900 transition-all" href="#"><i
                            class="iconify ph--linkedin-logo text-3xl"></i></a>
                    <a class="text-default-700 hover:text-default-900 transition-all" href="#"><i
                            class="iconify ph--x-logo text-3xl"></i></a>
                </div>
            </div>
            <div class="pb-4 px-6 flex justify-center space-x-4">
                <button class="btn bg-primary text-white">Follow</button>
        ...
        <div class="card overflow-hidden">
            <div class="relative">
                <img alt="Cover Image" class="w-full h-44 object-cover" src="{{ asset('images/small/img-3.jpg') }}"/>
                <div class="absolute -bottom-14 start-1/2 transform -translate-x-1/2">
                    <div class="relative">
                        <img alt="Profile Picture" class="w-28 h-28 rounded-full border-4 border-white shadow-md"
                             src="{{ asset('images/users/avatar-3.jpg') }}"/>
                        <span
                            class="absolute bottom-1 end-1 w-5 h-5 bg-yellow-500 border-2 border-white rounded-full"></span>
                    </div>
                </div>
            </div>
            <div class="pt-16 pb-4 text-center">
        ...
        <div class="card overflow-hidden">
            <div class="relative">
                <img alt="Cover Image" class="w-full h-44 object-cover" src="{{ asset('images/small/img-4.jpg') }}"/>
                <div class="absolute -bottom-14 start-1/2 transform -translate-x-1/2">
                    <div class="relative">
                        <img alt="Profile Picture" class="w-28 h-28 rounded-full border-4 border-white shadow-md"
                             src="{{ asset('images/users/avatar-4.jpg') }}"/>
                        <span
                            class="absolute bottom-1 end-1 w-5 h-5 bg-blue-500 border-2 border-white rounded-full"></span>
                    </div>
                </div>
            </div>
            <div class="pt-16 pb-4 text-center">
        ...
        <div class="card overflow-hidden">
            <div class="relative">
                <img alt="Cover Image" class="w-full h-44 object-cover" src="{{ asset('images/small/img-5.jpg') }}"/>
                <div class="absolute -bottom-14 start-1/2 transform -translate-x-1/2">
                    <div class="relative">
                        <img alt="Profile Picture" class="w-28 h-28 rounded-full border-4 border-white shadow-md"
        ...
        <div class="card overflow-hidden">
            <div class="relative">
                <img alt="Cover Image" class="w-full h-44 object-cover" src="{{ asset('images/small/img-6.jpg') }}"/>
                <div class="absolute -bottom-14 start-1/2 transform -translate-x-1/2">
                    <div class="relative">
                        <img alt="Profile Picture" class="w-28 h-28 rounded-full border-4 border-white shadow-md"
