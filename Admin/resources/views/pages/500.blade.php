        ...
        <div class="card overflow-hidden sm:rounded-md rounded-none">
            <div class="px-6 py-8">
                ...
                <div class="w-1/2 mx-auto block my-8">
                    <img src="{{ asset('images/500-error.svg') }}" title="maintenance.svg"/>
                </div>
                <h3 class="text-dark mb-4 mt-6 text-center text-3xl">Internal Server Error</h3>
                <p class="text-dark/75 mb-8 mx-auto text-base text-center">We are experiencing an internal server
                    problem, please try back later.</p>
